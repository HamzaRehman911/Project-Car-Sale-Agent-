...
class SellerHomeViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UITableViewDataSource,UITableViewDelegate {
    ...
    var lblmenutext = ["Home","Sell Car","Request Status","Profile","Logout"]
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationbar.title = "Seller Home";
        self.navigationController?.navigationBar.topItem?.title = "Seller Home"
        self.navigationController?.navigationItem.title = "Seller Home"
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == self.scollectionview
        {
            let cell = scollectionview.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! SlideImgCollectionViewCell
            ...
            let cell = featureofcollectionview.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! FeatureSCollectionViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if lblmenutext[indexPath.row] == "Home"{
            let cell1:SellerHomeViewController = self.storyboard?.instantiateViewController(withIdentifier: "SellerHomeViewController") as! SellerHomeViewController
        ...
        if lblmenutext[indexPath.row] == "Sell Car"{
            
            let cell2:sellcarViewController = self.storyboard?.instantiateViewController(withIdentifier: "sellcarViewController") as! sellcarViewController
            
            self.navigationController?.pushViewController(cell2, animated: true)
            print("Review Done")
        }
        if lblmenutext[indexPath.row] == "Request Status"{
            
            let cell3:RequestStatusViewController = self.storyboard?.instantiateViewController(withIdentifier: "RequestStatusViewController") as! RequestStatusViewController
        ...
        if lblmenutext[indexPath.row] == "Logout"{
            ...
            let cell5:LoginViewController = self.storyboard?.instantiateViewController(withIdentifier: "LoginViewController") as! LoginViewController
            
            self.navigationController?.pushViewController(cell5, animated: true)
            print("Logout Done")
        }
